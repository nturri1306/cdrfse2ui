...
public class NaviDrawer extends Div implements AfterNavigationObserver {
    ...
    private static final long serialVersionUID = -6280852041144924431L;
...
//		initSearch();
    ...
    private void initHeader() {
        mainContent.add(new BrandExpression(UIUtils.IMG_PATH + "logo.png"));
    }
...
//	}
    ...
    private void initFooter() {
        railButton = UIUtils.createSmallButton(getTranslation("app.main.collapse"), VaadinIcon.CHEVRON_LEFT_SMALL);
    ...
    private void toggleRailMode() {
        if (getElement().hasAttribute(RAIL)) {
            ...
            railButton.setText(getTranslation("app.main.collapse"));
            ...
            railButton.setText(getTranslation("app.main.expand"));
